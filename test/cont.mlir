...
func @co_optional_present_three(%return: !control.continuation<i32>) -> i32 {
  %val = constant 3 : i32
  ...
  optional.consume_co_opt(%0, %return, %return) :
    (!optional.co_option<i32>, !control.continuation<i32>, !control.continuation<i32>)
}
